...
class ChallengeAnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create challenge_answer" do
    assert_difference('ChallengeAnswer.count') do
      post challenge_answers_url, params: { challenge_answer: { challenge_id: @challenge_answer.challenge_id, input: @challenge_answer.input, output: @challenge_answer.output } }
    end
  ...
  test "should update challenge_answer" do
    patch challenge_answer_url(@challenge_answer), params: { challenge_answer: { challenge_id: @challenge_answer.challenge_id, input: @challenge_answer.input, output: @challenge_answer.output } }
