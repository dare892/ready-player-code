...
class RoomUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create room_user" do
    assert_difference('RoomUser.count') do
      post room_users_url, params: { room_user: { role: @room_user.role, room_id: @room_user.room_id, user_id: @room_user.user_id } }
    end
  ...
  test "should update room_user" do
    patch room_user_url(@room_user), params: { room_user: { role: @room_user.role, room_id: @room_user.room_id, user_id: @room_user.user_id } }
